...
describe("Register - Functional", () => {
  describe("Clocked", () => {
    ...
    it("initialises correctly", () => {
      ...
      expect(myRegister.readOutput()).toStrictEqual(ZERO_WORD);
    });
    ...
    it("Takes on value correctly", () => {
      ...
      myRegister.clock();
      expect(myRegister.readOutput()).toStrictEqual(VALUE);
    });
    ...
    it("Lifecycle test", () => {
      ...
      myRegister.clock();
      expect(myRegister.readOutput()).toStrictEqual(VALUE_A);
      ...
      myRegister.clock();
      expect(myRegister.readOutput()).toStrictEqual(VALUE_B);
      ...
      myRegister.clock();
      expect(myRegister.readOutput()).toStrictEqual(VALUE_C);
